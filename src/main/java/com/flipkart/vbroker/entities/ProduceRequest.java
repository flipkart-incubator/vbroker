...
public final class ProduceRequest extends Table {
  ...
  public short requiredAcks() { int o = __offset(8); return o != 0 ? bb.getShort(o + bb_pos) : 0; }
  ...
  public static void startProduceRequest(FlatBufferBuilder builder) { builder.startObject(4); }
  ...
  public static void addRequiredAcks(FlatBufferBuilder builder, short requiredAcks) { builder.addShort(2, requiredAcks, 0); }
