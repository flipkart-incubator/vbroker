...
public final class TopicPartitionProduceResponse extends Table {
  ...
  public short statusCode() { int o = __offset(6); return o != 0 ? bb.getShort(o + bb_pos) : 0; }
  ...
  public static void addStatusCode(FlatBufferBuilder builder, short statusCode) { builder.addShort(1, statusCode, 0); }
