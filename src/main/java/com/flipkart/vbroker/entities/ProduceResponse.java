...
public final class ProduceResponse extends Table {
  ...
  public static ProduceResponse getRootAsProduceResponse(ByteBuffer _bb, ProduceResponse obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public ProduceResponse __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public TopicProduceResponse topicResponses(int j) { return topicResponses(new TopicProduceResponse(), j); }
  public TopicProduceResponse topicResponses(TopicProduceResponse obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static void startProduceResponse(FlatBufferBuilder builder) { builder.startObject(1); }
