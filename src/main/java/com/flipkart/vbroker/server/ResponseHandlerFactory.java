    ...
    public ResponseHandler getResponseHandler(VResponse msg, ChannelHandlerContext ctx) {
        ...
        switch (msg.responseMessageType()) {
            ...
            case ResponseMessage.TopicCreateResponse:
                TopicCreateResponse topicCreateResponse = (TopicCreateResponse) msg.responseMessage(new TopicCreateResponse());
                assert topicCreateResponse != null;
                log.info("Received TopicCreateResponse with statusCode {}", topicCreateResponse.statusCode());
                responseHandler = new TopicCreateResponseHandler(topicCreateResponse);
                break;
        }
