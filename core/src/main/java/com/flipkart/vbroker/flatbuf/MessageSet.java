...
public final class MessageSet extends Table {
  public static MessageSet getRootAsMessageSet(ByteBuffer _bb) { return getRootAsMessageSet(_bb, new MessageSet()); }
  public static MessageSet getRootAsMessageSet(ByteBuffer _bb, MessageSet obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public MessageSet __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startMessageSet(FlatBufferBuilder builder) { builder.startObject(1); }
