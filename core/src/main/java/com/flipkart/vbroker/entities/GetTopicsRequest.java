...
public final class GetTopicsRequest extends Table {
  public static GetTopicsRequest getRootAsGetTopicsRequest(ByteBuffer _bb) { return getRootAsGetTopicsRequest(_bb, new GetTopicsRequest()); }
  public static GetTopicsRequest getRootAsGetTopicsRequest(ByteBuffer _bb, GetTopicsRequest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public GetTopicsRequest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startGetTopicsRequest(FlatBufferBuilder builder) { builder.startObject(1); }
