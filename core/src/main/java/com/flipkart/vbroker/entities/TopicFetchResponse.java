...
public final class TopicFetchResponse extends Table {
  public static TopicFetchResponse getRootAsTopicFetchResponse(ByteBuffer _bb) { return getRootAsTopicFetchResponse(_bb, new TopicFetchResponse()); }
  public static TopicFetchResponse getRootAsTopicFetchResponse(ByteBuffer _bb, TopicFetchResponse obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public TopicFetchResponse __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public TopicPartitionFetchResponse partitionResponses(int j) { return partitionResponses(new TopicPartitionFetchResponse(), j); }
  public TopicPartitionFetchResponse partitionResponses(TopicPartitionFetchResponse obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int partitionResponsesLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  ...
  public static void startTopicFetchResponse(FlatBufferBuilder builder) { builder.startObject(3); }
  ...
  public static void addPartitionResponses(FlatBufferBuilder builder, int partitionResponsesOffset) { builder.addOffset(2, partitionResponsesOffset, 0); }
