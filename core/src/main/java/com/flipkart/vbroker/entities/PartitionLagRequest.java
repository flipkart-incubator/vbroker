...
public final class PartitionLagRequest extends Table {
  public static PartitionLagRequest getRootAsPartitionLagRequest(ByteBuffer _bb) { return getRootAsPartitionLagRequest(_bb, new PartitionLagRequest()); }
  public static PartitionLagRequest getRootAsPartitionLagRequest(ByteBuffer _bb, PartitionLagRequest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public PartitionLagRequest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startPartitionLagRequest(FlatBufferBuilder builder) { builder.startObject(1); }
