...
public final class TopicSubscriptionLagRequest extends Table {
  public static TopicSubscriptionLagRequest getRootAsTopicSubscriptionLagRequest(ByteBuffer _bb) { return getRootAsTopicSubscriptionLagRequest(_bb, new TopicSubscriptionLagRequest()); }
  public static TopicSubscriptionLagRequest getRootAsTopicSubscriptionLagRequest(ByteBuffer _bb, TopicSubscriptionLagRequest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public TopicSubscriptionLagRequest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public short subscriptionId() { int o = __offset(4); return o != 0 ? bb.getShort(o + bb_pos) : 0; }
  public short topiId() { int o = __offset(6); return o != 0 ? bb.getShort(o + bb_pos) : 0; }
  public PartitionLagRequest partitionLags(int j) { return partitionLags(new PartitionLagRequest(), j); }
  public PartitionLagRequest partitionLags(PartitionLagRequest obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static void startTopicSubscriptionLagRequest(FlatBufferBuilder builder) { builder.startObject(3); }
  public static void addSubscriptionId(FlatBufferBuilder builder, short subscriptionId) { builder.addShort(0, subscriptionId, 0); }
  public static void addTopiId(FlatBufferBuilder builder, short topiId) { builder.addShort(1, topiId, 0); }
