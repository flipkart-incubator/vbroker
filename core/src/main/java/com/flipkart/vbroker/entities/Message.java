...
public final class Message extends Table {
  ...
  public short partitionId() { int o = __offset(16); return o != 0 ? bb.getShort(o + bb_pos) : 0; }
  ...
  public byte httpMethod() { int o = __offset(22); return o != 0 ? bb.get(o + bb_pos) : 0; }
  public short callbackTopicId() { int o = __offset(24); return o != 0 ? bb.getShort(o + bb_pos) : 0; }
  ...
  public byte callbackHttpMethod() { int o = __offset(28); return o != 0 ? bb.get(o + bb_pos) : 0; }
  ...
  public static void addPartitionId(FlatBufferBuilder builder, short partitionId) { builder.addShort(6, partitionId, 0); }
  ...
  public static void addHttpMethod(FlatBufferBuilder builder, byte httpMethod) { builder.addByte(9, httpMethod, 0); }
  public static void addCallbackTopicId(FlatBufferBuilder builder, short callbackTopicId) { builder.addShort(10, callbackTopicId, 0); }
  ...
  public static void addCallbackHttpMethod(FlatBufferBuilder builder, byte callbackHttpMethod) { builder.addByte(12, callbackHttpMethod, 0); }
