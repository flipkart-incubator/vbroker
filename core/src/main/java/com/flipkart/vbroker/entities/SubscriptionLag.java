...
public final class SubscriptionLag extends Table {
    public static SubscriptionLag getRootAsSubscriptionLag(ByteBuffer _bb) {
        return getRootAsSubscriptionLag(_bb, new SubscriptionLag());
    }

    public static SubscriptionLag getRootAsSubscriptionLag(ByteBuffer _bb, SubscriptionLag obj) {
    ...
    public static void startSubscriptionLag(FlatBufferBuilder builder) {
        builder.startObject(3);
    }
    ...
    public SubscriptionLag __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public PartitionLag partitionLags(int j) {
        return partitionLags(new PartitionLag(), j);
    }

    public PartitionLag partitionLags(PartitionLag obj, int j) {
        int o = __offset(8);
