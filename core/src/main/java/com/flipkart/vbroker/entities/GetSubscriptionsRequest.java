...
public final class GetSubscriptionsRequest extends Table {
    public static GetSubscriptionsRequest getRootAsGetSubscriptionsRequest(ByteBuffer _bb) {
        return getRootAsGetSubscriptionsRequest(_bb, new GetSubscriptionsRequest());
    }

    public static GetSubscriptionsRequest getRootAsGetSubscriptionsRequest(ByteBuffer _bb, GetSubscriptionsRequest obj) {
    ...
    public static void startGetSubscriptionsRequest(FlatBufferBuilder builder) {
        builder.startObject(1);
    }
    ...
    public GetSubscriptionsRequest __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }

    public TopicSubscription subscriptions(int j) {
        return subscriptions(new TopicSubscription(), j);
    }

    public TopicSubscription subscriptions(TopicSubscription obj, int j) {
        int o = __offset(4);
