...
public class CuratorServiceTest extends BaseClassForTests {
    ...
    public void shouldCreateNode() {
        ...
        AsyncStage<String> stage = curatorService.createNode(path, CreateMode.PERSISTENT, true);
    ...
    public void shouldSetData_GetSetDataAndValidate() {
        ...
        Stat stat = curatorService.createNode(path, CreateMode.PERSISTENT, true)
    ...
    public void shouldCreateChildNodesWithParent_AndGetChildNodesForParent() {
        ...
        List<String> createdNodes = childNodes.stream()
            .map(childNode -> curatorService
                .createNode(parentNode + "/" + childNode, CreateMode.PERSISTENT, true)
                .toCompletableFuture().join())
            .sorted()
    ...
    private void createNode(String fullChildPath, String childNodeData) {
        String path = curatorService.createNodeAndSetData(fullChildPath, CreateMode.PERSISTENT, childNodeData.getBytes(), true)
            .toCompletableFuture().join();
